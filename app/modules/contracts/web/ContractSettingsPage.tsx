...
export default function ContractSettingsPage({
  ...
  mtData: CollectionData<MembershipType>;
  tarifData: CollectionData<Tarif>;
  dgData: CollectionData<DiscountGroup>;
  groupData: CollectionData<ContractGroup>;
  actionData?: ContractSettingsActionData;
}) {
    ...
    <Stack gap="lg">
      ...
      <Tabs defaultValue="settings">
        ...
        <Tabs.Panel value="settings" pt="md">
          {isLoading ? (
            <Text c="dimmed" ta="center" p="xl">Laden...</Text>
          ) : (
            <Stack gap="md">
              <Card>
