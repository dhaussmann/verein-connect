...
export default function ContractNew({
  ...
  membersData: ContractNewListData<Member>;
  mtData: ContractNewListData<MembershipType>;
  tarifData: ContractNewListData<Tarif>;
  groupsData: ContractNewListData<ContractGroup>;
  actionData?: ContractNewActionData;
