...
import { useCreateContract, useMembers, useMembershipTypes, useTarifs, useGroups } from '@/hooks/use-api';
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Select value={form.contract_kind} onValueChange={(v) => set('contract_kind', v)}>
